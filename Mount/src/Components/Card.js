    ...
    return (
      <div class="container card text-white box-border" style={myStyleOne}>
        <div class="row card-header ">
          {/* <span><img class="activity" src={`${require('./images/activity.png')}`} /></span> */}
          <span><i class="fa fa-bars fa-1x icon-size"></i></span>
          <span class=""  style={{paddingLeft: "5px"}}>Activity Feed</span>
        </div>
        <div style={{paddingTop: "5px",color: "#5e5a5a",fontSize: "15px",fontWeight: "500"}}>Today</div>
        <div class="container cardBodyNew" >
          <div class="card text-white mb-3" style={{border: "none"}}>
            ...
            <div class="row people left-menu-item" style={{fontSize: "12px"}}>
                <span class="col-1 profile-img"><img src={Person} class="roundedImage"/></span>
                <span class="col-4 menu-item-color menu-item-font">Smith</span>
                <span class="col-7 menu-item-color menu-item-small-font">added 10 min ago</span>
            </div>
            <div class="row people left-menu-item" style={{fontSize: "12px",marginLeft: "28px"}}>
                <span class="col-1 profile-img"><img src={Person1} class="roundedImage"/></span>
                <span class="col-4 menu-item-color menu-item-font">John</span>
                <span class="col-7 menu-item-color menu-item-small-font">commented 2 hrs ago</span>
            </div>
            <div class="row people left-menu-item" style={{fontSize: "12px",marginLeft: "28px"}}>
                <span class="col-1 profile-img"><img src={Person2} class="roundedImage"/></span>
                <span class="col-4 menu-item-color menu-item-font">Nicole</span>
                <span class="col-7 menu-item-color menu-item-small-font">ranked dataset 3 hrs ago</span>
            </div>
          </div>
          ...
          <div class="card text-white mb-3" style={{border: "none"}}>
            ...
            <div class="row people left-menu-item" style={{fontSize: "12px"}}>
                <span class="col-1 profile-img"><img src={Person3} class="roundedImage"/></span>
                <span class="col-4 menu-item-color menu-item-font">Brett</span>
                <span class="col-7 menu-item-color menu-item-small-font">added 10 min ago</span>
            </div>
            <div class="row people left-menu-item" style={{fontSize: "12px",marginLeft: "28px"}}>
                <span class="col-1 profile-img"><img src={Person5} class="roundedImage"/></span>
                <span class="col-4 menu-item-color menu-item-font">Adam</span>
                <span class="col-7 menu-item-color menu-item-small-font">commented 3 hrs ago</span>
            </div>
          </div>
          ...
          <div class="card text-white mb-3" style={{border: "none"}}>
            ...
            <div class="row people left-menu-item" style={{fontSize: "12px"}}>
                <span class="col-1 profile-img"><img src={Person6} class="roundedImage"/></span>
